...
This field helps organizers ensure that the conference covers a diverse range of themes.`;

exports.other=`A coma separated list of speaker ID. Each speaker needs to already have an account on this website.

The speaker can find their ID by clicking on 'Account' and copying the content of the read-only 'ID' field.

Each of the speakers will need to connect and confirm their participation for the proposal to be sucessfully submitted.`